(defproject usersearch.v1/v1 "1.0.0SNAPSHOT"
  ...
  :auto-clean true
  ;;:main ^:skip-aot
  :aliases {"api-repl" ["with-profile" "+api" "repl"]
            "cljs-repl" ["with-profile" "+ui" "repl" ":connect" "localhost:9090"]}
  :repl-options {:init-ns api.main
                 :nrepl-middleware [shadow.cljs.devtools.server.nrepl/middleware]}
  :profiles {:api {:dependencies [[org.clojure/clojure "1.10.3"]
                                  [metosin/reitit "0.5.15"]
                                  [ring/ring-jetty-adapter "1.8.2"]
                                  [cprop "0.1.19"]
                                  [mount "0.1.16"]]}
             :ui {:source-paths ["src"] ;;same as api source-path
